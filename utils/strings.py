...
class English(object):
    ...
    def __init__(self):
        ...
        self.callback_change_status_success = "You are now {new_status}"
        self.callback_remove_user_success = "You have successfuly unsubscribed. You can register again at any time with /register ZIPCODE"
